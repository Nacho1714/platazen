    ...
    <div class="row g-0">
        ...
        <div class="col-lg-5 bg-dark d-flex flex-column align-items-end min-vh-100">
            ...
            <div class="form-login align-self-center w-100 px-lg-5 py-lg-4 p-4 h-100 flex-column justify-content-lg-around d-flex">
                <h2 class="font-weight-bold mb-4 h1">Cree su cuenta</h2>
                <form class="mb-5" action="actions/auth/log-up.php" method="post" novalidate>
                    <div class="mb-4">
                    ...
                    <div class="mb-4">
                        <label for="confirm-password" class="form-label font-weight-bold">Confirmar Contraseña</label>
                        <div class="input-group">
                            <input
                                ...
                                class="form-control bg-dark-x border-0 mb-2 text-white"
                                id="confirm-password"
                                value="<?= $oldData['confirm-password'] ?? '' ?>"
